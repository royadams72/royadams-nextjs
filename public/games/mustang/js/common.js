...
var Render = {
  ...
  background: function(ctx, background, width, height, layer, rotation, offset) {
    ...
    var destH = height;
	 if(layer==BACKGROUND.SKY){
		 ctx.drawImage(background, sourceX, sourceY, sourceW, sourceH, destX, destY-100, destW, destH);
		//  console.log(destY);
	  }else{
    ...
    if (sourceW < imageW){
		 if(layer==BACKGROUND.SKY){
      ctx.drawImage(background, layer.x, sourceY, imageW-sourceW, sourceH, destW-1, destY-100, width-destW, destH)
		  }else{
  ...
  sprite: function(ctx, width, height, resolution, roadWidth, sprites, sprite, scale, destX, destY, offsetX, offsetY, clipY) {
	   ...
	   if(lap ==1){
		   sprites = new Image();
		   sprites.src = "images/_expanded/car2.png";
	   }else{
		   sprites = new Image();
		   sprites.src = "images/_expanded/car1.png"; 
  ...
  player: function(ctx, width, height, resolution, roadWidth, sprites, speedPercent, scale, destX, destY, steer, updown) {
    ...
    var bounce = (1 * Math.random() * speedPercent * resolution) * Util.randomChoice([-1,1]);
    var sprite;
