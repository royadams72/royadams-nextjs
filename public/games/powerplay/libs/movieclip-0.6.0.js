...
(function() {
    ...
    a._updateTimeline = function() {
        ...
        if (this._prevPos != b._prevPos) {
            ...
            for (b = a.length - 1; 0 <= b; b--) e = a[b], f = e._target, f != this && (e = e._stepPosition, f instanceof createjs.DisplayObject ? this._addManagedChild(f, e) : this._setState(f.state, e));
