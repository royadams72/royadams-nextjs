...
(function() {
    ...
    a.installPlugin = function(b) {
        if (!(b == null || b.getPreloadHandlers == null)) {
            ...
            if (b.types != null)
                for (var a = 0, d = b.types.length; a <
        ...
        switch (typeof j) {
            ...
            case "object":
                ...
                if (h && typeof h === "object") {
                    ...
                    for (n in j) Object.prototype.hasOwnProperty.call(j, n) && (m = d(n, j)) && k.push(a(n) + (f ? ": " : ":") + m);
                m = k.length === 0 ? "{}" : f ? "{\n" + f + k.join(",\n" +
                    f) + "\n" + q + "}" : "{" + k.join(",") + "}";
                f = q;
                return m
    ...
    if (typeof JSON.parse !== "function") JSON.parse = function(a, c) {
        function d(a, b) {
            ...
            if (f && typeof f === "object")
                for (e in f) Object.prototype.hasOwnProperty.call(f, e) && (g = d(f, e), g !== void 0 ? f[e] = g : delete f[e]);
            return c.call(a, b, f)
        }
        var e, a = String(a);
        b.lastIndex = 0;
